        ...
        <?php $this->app->hook->{'do_action'}('login_form_top'); ?>
            <div class="panel panel-login">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="login-form" action="<?= Core\get_base_url(); ?>login/" method="post" role="form" style="display: block;" autocomplete="off">
                                <h2><?= Core\_t('Login', 'tritan-cms'); ?></h2>
                            ...
                            <form id="register-form" action="<?= Core\get_base_url(); ?>reset-password/" method="post" role="form" style="display: none;">
                                <h2><?= Core\_t('Lost Password', 'tritan-cms'); ?></h2>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <input type="submit" name="reset_password" tabindex="4" class="form-control btn btn-register" value="<?= Core\_t('Reset Password', 'tritan-cms'); ?>">
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-6 tabs">
                            <a href="#" class="active" id="login-form-link"><div class="login"><?= Core\_t('Login', 'tritan-cms'); ?></div></a>
                        </div>
                        <div class="col-xs-6 tabs">
                            <a href="#" id="register-form-link"><div class="register"><?= Core\_t('Lost Password', 'tritan-cms'); ?></div></a>
                        </div>
                    </div>
                </div>
            </div>
