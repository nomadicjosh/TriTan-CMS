                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="ttcms_core_locale" style="width: 100%;" required>
                                        <option>&nbsp;</option>
                                        <?php ttcms_dropdown_languages($this->app->hook->{'get_option'}( 'ttcms_core_locale' )); ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="enable_cron_jobs" style="width: 100%;" required>
                                        <option value=""> ------------------------- </option>
                                        <option value="1"<?=selected( $this->app->hook->{'get_option'}( 'enable_cron_jobs' ), '1', false ); ?>><?=_t( "On" );?></option>
                                        <option value="0"<?=selected( $this->app->hook->{'get_option'}( 'enable_cron_jobs' ), '0', false ); ?>><?=_t( "Off" );?></option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="site_cache" style="width: 100%;" required>
                                        <option value=""> ------------------------- </option>
                                        <option value="1"<?=selected( $this->app->hook->{'get_option'}( 'site_cache' ), '1', false ); ?>><?=_t( "On" );?></option>
                                        <option value="0"<?=selected( $this->app->hook->{'get_option'}( 'site_cache' ), '0', false ); ?>><?=_t( "Off" );?></option>
                                    </select>
                                </div>
                                <div class="form-group">
