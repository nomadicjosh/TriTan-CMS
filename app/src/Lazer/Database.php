...
namespace TriTan\Lazer;

use TriTan\Lazer\Helpers;
use TriTan\Exception\LazerException;
use TriTan\Lazer\Relation;
...
class Database implements \IteratorAggregate, \Countable
{
     ...
     * @param array $data key value pair
     * @return bool
     * @throws LazerException If insert fails.
     */
    public function insert(array $data)
    {
        ...
        throw new LazerException('Insert failed');
    }
     ...
     * @param array $data key value pair
     * @return boolean
     * @throws LazerException If update failed.
     */
    public function update(array $data)
    {
        ...
        throw new LazerException('Update failed.');
    }
