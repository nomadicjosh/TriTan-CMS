 ...
 */
class CacheJSON extends \TriTan\Cache\AbstractCache implements CacheInterface
{
    /**
    ...
    public function delete($key, $namespace = 'default')
    {
        ...
        return rename($filename, $filename . $this->increment($key, 1, $namespace));
    }
    ...
    public function getStats()
    {
        ...
        echo "<strong>Last Update:</strong> " . date('F d Y h:i A', filemtime($this->dir)) . "<br />";
        echo "</p>";
    }
     ...
     * {@inheritDoc}
     *
     * @see TriTan\Cache\AbstractCache::increment()
     *
     * @since 0.9.9
     * @access public
     *
     ...
     * {@inheritDoc}
     *
     * @see TriTan\Cache\AbstractCache::decrement()
     *
     * @since 0.9.9
     *
     * @param int|string $key
